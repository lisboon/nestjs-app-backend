...
const makeSut = ({ currentPasswordMatches = true } = {}) => {
  ...
  const useCase = new ChangePasswordUseCase(userGateway as any, passwordHashService as any);
...
describe('ChangePasswordUseCase', () => {
  it('replaces the password after validating the current one', async () => {
    ...
    expect(passwordHashService.compare).toHaveBeenCalledWith('OldSecret99', '$2b$12$oldhash');
